...
These files are created when you select the workflow bundle in `al wizard`. The bundled memory instructions reference them as long-lived memory for the repo:
