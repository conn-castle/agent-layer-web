...
If you prefer to avoid the VS Code launcher, the best alternative is to configure MCP servers globally for the Codex VS Code extension. See [/docs/troubleshooting#global-mcp-server-fallback-for-vs-code-codex](/docs/troubleshooting#global-mcp-server-fallback-for-vs-code-codex).
