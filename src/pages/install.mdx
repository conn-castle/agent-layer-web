---
title: Install
description: Install Agent Layer on macOS or Linux to configure coding agents once, use Agent Dispatch, and share portable Agent Skills across clients.
keywords:
  - install Agent Layer
  - coding agent CLI
...
- Try multi-agent delegation with [Agent Dispatch](/docs/agent-dispatch)
- [Import an Agent Skill from Git](/docs/skill-imports)
...
For the full upgrade policy (event model, compatibility guarantees, migration rules, and platform matrix), see [/docs/upgrades](/docs/upgrades).
