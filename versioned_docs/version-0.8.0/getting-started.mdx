...
If you prefer to launch VS Code without the repo-local launcher, see [Global MCP server fallback for VS Code (Codex)](./troubleshooting#global-mcp-server-fallback-for-vs-code-codex).
:::
