...
Generated client outputs are meant to be disposable. If you see generated files like `.agent/skills/`, `.gemini/settings.json`, `.claude/settings.json`, `.codex/`, `.copilot/`, `.github/skills/`, `.vscode/mcp.json`, `.vscode/prompts/`, `.vscode/settings.json`, `.mcp.json`, `.github/copilot-instructions.md`, `AGENTS.md`, `CLAUDE.md`, or `GEMINI.md` showing up in `git status`, it usually means one of:
