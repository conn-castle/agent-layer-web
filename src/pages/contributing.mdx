...
- VS Code launch architecture (contributor reference): [docs/architecture/vscode-launch.md](https://github.com/conn-castle/agent-layer/blob/main/docs/architecture/vscode-launch.md)
...
For public authoring guidance, use the [Best Practices hub](/best-practices), including [Skill Design](/skill-design), [CLI Skill Design](/cli-skill-design), and [Instruction Design](/instruction-design).
