...
- Install the target client (Gemini, Claude, Codex, Copilot CLI, VS Code, Antigravity)
...
Any client command (gemini/claude/codex/copilot/vscode/antigravity) will:
...
- generated client outputs like `.agent/skills/`, `.gemini/settings.json`, `.claude/settings.json`, `.mcp.json`, `.codex/`, `.copilot/`, `.github/skills/`, `.vscode/mcp.json`, `.vscode/prompts/`, `.vscode/settings.json`, `.github/copilot-instructions.md`, `AGENTS.md`, `CLAUDE.md`, `GEMINI.md`
