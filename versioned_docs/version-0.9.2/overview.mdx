...
The payoff is fewer surprises: the same repo behaves the same whether you launch Gemini, Claude, Codex, Copilot CLI, VS Code, or Antigravity. No copying configuration between clients. No gradual drift. Just one place to review and refine how your agents work.
...
5. [Troubleshooting](./troubleshooting) - common errors and fixes
6. [Upgrades](./upgrades) - upgrade event model, compatibility guarantees, and migration rules
...
Built-in workflow skills that give agents structured processes for common tasks. Includes: [The built-in skill library](./skills#the-built-in-skill-library), [Skill categories](./skills#skill-categories), [Anatomy of a skill](./skills#anatomy-of-a-skill), and [Writing your own skills](./skills#writing-your-own-skills).
