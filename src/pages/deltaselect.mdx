...
**Provisional citation — replace with the paper's published citation before release:**

```bibtex
@article{conn2026deltaselect,
  title   = {DeltaSelect: Budget-Aware Task Selection for Agent Benchmarks},
...
{/* Replace the paper URL and provisional citation above with the published arXiv metadata before release. */}
