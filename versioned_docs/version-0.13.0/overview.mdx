...
- Deterministic generated outputs that are safe to delete and recreate (apart from a couple of documented shared-state files that `al sync` patches in place).
