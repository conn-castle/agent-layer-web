...
Run [`al init`](./reference#init) in the repo to create `.agent-layer/`. To add `docs/agent-layer/` memory files when the workflow bundle is absent, run [`al wizard`](./reference#wizard) and install the workflow bundle.
