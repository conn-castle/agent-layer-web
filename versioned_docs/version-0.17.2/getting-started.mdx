...
The resulting layout always has configuration and generated client files. Project memory is an optional third bucket, created only when you install the workflow bundle in `al wizard`.
